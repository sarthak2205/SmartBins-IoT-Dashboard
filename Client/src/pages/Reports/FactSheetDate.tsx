...
const FactSheetDate = () => {
  ...
  useEffect(() => {
    const fetchWaste = async () => {
      try {
        const res = await axios.get(`http://localhost:8080/reports/waste/` + path);
        setWaste(res.data);
      } catch(error) {
  ...
  return (
    <>
      <Breadcrumb pageName={`FactSheet of Date - ${path}`} />
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form>
              <div className="p-6.5">
                    ...
                    return (
                      <>
                        <div className={`border-b border-stroke pt-5 ${getColorClass(colorId)}`} key={key}>
                          ...
                          <div className="mb-4.5 grid grid-cols-2 w-full">
                            <div className="w-full xl:w-1/2 ">
                              <label className="mb-2.5 block text-black dark:text-white whitespace-nowrap">
                                Number of <span className={`font-bold`}>{colorDetails.colorName} Bags</span> generated
                              </label>
                            </div>
                            <div className="w-full xl:w-1/2">
                              <label className="mb-2.5 block text-black dark:text-white">
                            ...
                            <div className="w-full xl:w-1/2">
                              <label className="mb-2.5 block text-black dark:text-white whitespace-nowrap">
                                Weight of <span className={`font-bold`}>{colorDetails.colorName} Bags</span> generated
                              </label>
                            </div>
                ...
                <div className='flex flex-col'>
                  <h1 className='text-4xl font-bold text-center italic underline py-12'> Truck Driver Entry </h1>
                  <div className='border-b border-stroke'>
                    {Object.keys(summarizedData).map((colorId, key) => {
                    const colorDetails = summarizedData[colorId];
                      ...
                      <>
                        <div className={`border-b border-stroke pt-5 ${getColorClass(colorId)}`} key={key}>
                          ...
                          <div className="mb-4.5 grid grid-cols-2 w-full">
                            ...
                            <div className="w-full xl:w-1/2">
                              <label className="mb-2.5 block text-black dark:text-white">
                                : <span className='pl-5'>{colorDetails.bagsPicked ? colorDetails.bagsPicked : "No data"}</span>
                              </label>
                            </div>
                            ...
                            <div className="w-full xl:w-1/2">
                              <label className="mb-2.5 block text-black dark:text-white">
                                : {colorDetails.weightPicked ? <span className='pl-5'>{colorDetails.weightPicked} Kgs</span> : <span className='pl-5'>No data</span>}
                              </label>
                            </div>
                          </div>
                        </div>
                ...
                {waste.length > 0 && (
                  ...
                  <div className='border-b border-stroke'>
                    ...
                    <div className="mb-4.5 grid grid-cols-2 w-full">
                      ...
                      <div className="w-full xl:w-1/2">
                        <label className="mb-2.5 block text-black dark:text-white">
                          : <span className='pl-5'>{waste[0]['Driver Name']}</span> 
                        </label>
                      </div>
                      <div className="w-full xl:w-1/2 ">
                        <label className="mb-2.5 block text-black dark:text-white whitespace-nowrap">
                      ...
                      <div className="w-full xl:w-1/2">
                        <label className="mb-2.5 block text-black dark:text-white">
                          : <span className='pl-5'>{waste[0]['Contact Number']}</span> 
                        </label>
                      </div>
                      ...
                      <div className="w-full xl:w-1/2">
                        <label className="mb-2.5 block text-black dark:text-white">
                          : <span className='pl-5'>{waste[0]['Plate Number']}</span> 
                        </label>
                      </div>
