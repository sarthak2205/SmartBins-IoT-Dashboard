...
import EYLogo from '../images/logo/EYLogo.png';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-0 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={EYLogo} alt="Logo" className='h-40'/>
        </NavLink>
        ...
        <nav className="mt-5 py-0 px-4 lg:mt-0 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item for adding Device --> */}
              <li>
                <NavLink
                  to="/Add_Device"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('Add_Device') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <div>
                    <BsDeviceSsd />
              ...
              {/* <!-- Menu Item END for adding Device --> */}

              {/* <!-- Menu Item for Adding Waste --> */}
              <li>
                <NavLink
                  to="/Add_Waste"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('Add_Waste') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <div>
                    <GiWaterDrop />
              ...
              {/* <!-- Menu Item END for Adding Waste --> */}
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Reports
                        <span
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current duration-300 ${
                            open && 'rotate-180'
                          }`}
                        ><AiOutlineDown />
                        </span>
